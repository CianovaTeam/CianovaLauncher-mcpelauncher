...
class AboutTab(QWidget):
    def __init__(self, parent, app):
        ...
        # Title
        self.title_label = QLabel(c.UI_TITLE_LEGAL)
        ...
        self.lbl_legal = QLabel(c.LEGAL_TEXT)
        ...
        # Credits
        self.credits_label = QLabel(c.CREDITOS)
        ...
        self.version_label = QLabel(f"{c.UI_VERSION_TEXT}{c.VERSION_LAUNCHER}")
